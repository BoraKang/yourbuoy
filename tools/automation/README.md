...
yourBuoy의 비공개 경험 수집과 블로그 편집 루프를 연결하는 운영 도구다.
...
Daily Catch 전체가 자동으로 블로그 아이템이 되지는 않는다. 주간 선별 결과를 사용자가 선택한 뒤에만 Notion 씨앗으로 등록한다. 발행·커밋·푸시는 사용자 승인 없이 수행하지 않는다.
...
- Codex 자동화: `~/.codex/automations/yourbuoy-2`, `yourbuoy-3`
